...
export default function TermsUsePage() {
  ...
  return (
    <>
      <MetaTags metaTitle={t('pages.regulations.meta_title')} metaDescription={t('pages.regulations.meta_description')} />
      <div className="container content-text">
        <Titles title={t('pages.regulations.title')} subTitle={t('pages.regulations.sub_title')} />
