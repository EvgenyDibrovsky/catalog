        ...
        <div className="container flex flex-col lg:flex-row">
          <div className="w-full lg:w-5/12 flex flex-col justify-between items-center py-16">
            <div className="w-full lg:w-11/12">
              <h1 className="mb-11 text-left text-[2rem] leading-1 font-semibold">
                {item['title']}
              </h1>
            ...
            <div className="flex items-center gap-4">
              {item.offer && (
                <button className="border px-4 py-1 border-sky-600 dark:border-yellow-500 bg-sky-600 dark:bg-yellow-500 text-white dark:text-black">
                  {t('hero_slider.btn_offer')}
                </button>
              )}
              <button className="border  px-4 py-1 border-sky-600 dark:border-yellow-500 text-black dark:text-white">
